...
<%
    Session("activePage") = "Developers - RequestVariablesXML"
    Session("currentPage") = "developers/z2t_developers_RequestVariablesXML.asp"
    Session("devPage") = "RequestVariablesXML"
%>

<html lang="en">
  <head>
    <title>Developer Information | XML Response - Zip2Tax.com</title>
  ...
  <body>  
    <div class="container-fluid" style="padding: 0px;">
      ...
      <div class="mainBody">
		...
		<!-- #include virtual="/Website/pagesSupport/Developers/Dev_RequestVariablesXML/page_developers_RequestVariablesXML_content.asp" -->
