...
<html>
  <head>
	...
	<script language="javascript" src="/Website/Includes/Javascript/page_developers_RequestVariables.js" type="text/javascript"></script>
    <!--#include virtual="/Website/Includes/BodyParts/newHeading.asp"-->
		...
		<!-- #include virtual="/Website/pagesSupport/Developers/Dev_RequestVariables/page_developers_RequestVariables_content_new.asp" -->
