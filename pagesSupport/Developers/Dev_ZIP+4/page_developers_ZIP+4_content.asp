<div id="content">
  ...
  <div class="post">
    ...
    <div class="entry">
      ...
      provides for  XML or JSON responses at the ZIP+4 or ZIP code levels.
	  ...
	  addresses found within the ZIP codes from 90001 to 90999. If you 
	  would like to perform testing outside of that range, please call 
	  866-492-8494 or <a href="mailto:info@zip2tax.com">e-mail</a> us to 
	  request a free limited-time account. For subscription information, 
	  check out our 
	  <a href="/free-sales-tax-calculator#PageSection2">
	  Database Interface pricing</a>.</p>
    </div><!-- entry -->
  </div><!-- post -->
  ...
  <div class="post">
    ...
    <div class="entry">
      <p>Click on the sample code below to see what the ZIP+4 level 
	  result would look like in browser for a ZIP+4 code in Beverly 
	  Hills, California. In a practical application you would 
	  typically read the results into a XMLHttpRequest object.</p>
      
      <a href="https://api.zip2tax.com/TaxRate-USA.xml?username=sample&amp;password=password&amp;zip=90210-3303" target="_blank">
	  https://api.zip2tax.com/TaxRate-USA.xml?username=sample&amp;password=password&amp;zip=90210-3303</a>
    ...
    <div class="post">
      ...
      <div class="entry">
        <p>For a JSON response, simply replace .XML with .JSON, as 
		seen below:</p>

        <a href="https://api.zip2tax.com/TaxRate-USA.json?username=sample&amp;password=password&amp;zip=90210-3303" target="_blank">
		https://api.zip2tax.com/TaxRate-USA.json?username=sample&amp;password=password&amp;zip=90210-3303</a>
