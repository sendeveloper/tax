	  ...
	  <!-- START: HOW DOES YOUR ONLINE LOOKUP HANDLE ZIP CODES THAT HAVE MORE THAN ONE TAX RATE? -->
	  <div class="AccordionPanel">
        <div class="AccordionPanelTab">
          <h3><strong>How does your Online Lookup handle ZIP codes that have more than one tax rate?</strong></h3>
        </div><!-- AccordionPanelTab -->
        <div class="AccordionPanelContent">
          
          <div class="divContent18">
			...
			<p><a href="/Website/pagesProducts/Cart/Online_Zip+4/online_zip+4_popup.asp" 
			...
			<p><a href="/Website/pagesProducts/Cart/Online_Zip/online_zip_popup.asp" target="_blank">
	  ...
	  <!-- END: HOW DOES YOUR ONLINE LOOKUP HANDLE ZIP CODES THAT HAVE MORE THAN ONE TAX RATE? -->	  