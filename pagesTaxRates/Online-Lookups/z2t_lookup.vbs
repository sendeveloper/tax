...
Dim maxSubscriptionServiceLevel
Dim expiration
...
If Not IsEmpty(Request("hiddenZip")) Then
    'Protect against injection attacks
'    zipInput = Left(Request("hiddenZip"), 5)
...
maxSubscriptionServiceLevel = 0

If Session("z2t_loggedin") = "True" then
'    sqlConnectionString = "Driver=SQL Server;server=barley4.harvestamerican.net;uid=davewj2o;pwd=get2it;database=z2t_Zip4"
'    Dim sqlTextForSubscriptionServiceLevel: sqlTextForSubscriptionServiceLevel = "exec z2t_Zip4.dbo.z2t_GetSubscriptions '" & Session("z2t_UserName") & "'"
'    sqlConnectionString = "Driver=SQL Server;server=dallas01.harvestamerican.net;uid=davewj2o;pwd=get2it;database=Zip4Dev"
'    Dim sqlTextForSubscriptionServiceLevel: sqlTextForSubscriptionServiceLevel = "exec Zip4Dev.dbo.z2t_GetSubscriptions '" & Session("z2t_UserName") & "'"
'    sqlConnectionString = "Driver=SQL Server;server=api.Zip2Tax.com;uid=z2t_PinPoint_User;pwd=get2PinPoint;database=z2t_Zip4"
'    sqlConnectionString = "Driver=SQL Server;Initial Catalog=z2t_Zip4;Data Source=api.Zip2Tax.com;User ID=z2t_PinPoint_User;Password=get2PinPoint"
'    sqlConnectionString = "Provider=SQLOLEDB;Data Source=api.Zip2Tax.com;Initial Catalog=z2t_Zip4;UID=z2t_PinPoint_User;PWD=get2PinPoint"
    'sqlConnectionString = "Provider=SQLOLEDB;Data Source=208.88.49.22,8543;Initial Catalog=z2t_Zip4;UID=z2t_PinPoint_User;PWD=get2PinPoint"
    sqlConnectionString = "Provider=SQLOLEDB;Data Source=127.0.0.1;Initial Catalog=z2t_Zip4;UID=z2t_PinPoint_User;PWD=get2PinPoint"
    Dim sqlTextForSubscriptionServiceLevel: sqlTextForSubscriptionServiceLevel = "exec z2t_Zip4.dbo.z2t_GetSubscriptions '" & Session("z2t_UserName") & "'"
    Dim rsForSubscriptionServiceLevel
    Set rsForSubscriptionServiceLevel = Sql(sqlTextForSubscriptionServiceLevel)
    Do While Not rsForSubscriptionServiceLevel.EOF
      If rsForSubscriptionServiceLevel("SubscriptionType") = 0 Then
        maxSubscriptionServiceLevel = 3 ' Admin
        'Exit Loop
      ElseIf rsForSubscriptionServiceLevel("SubscriptionType") = 1 And (rsForSubscriptionServiceLevel("SubscriptionServiceLevel") > maxSubscriptionServiceLevel) Then
        maxSubscriptionServiceLevel = rsForSubscriptionServiceLevel("SubscriptionServiceLevel")
      End If
      rsForSubscriptionServiceLevel.movenext
    Loop
End If
...
Function LookupNotes(zipCode)
    ...
    If Not (rsLookup Is Nothing) Then
        ...
        LookupNotes = True
    Else
        LookupResults.ErrorMessage = "Lookup Failed. (z2t:4)"
    End If
