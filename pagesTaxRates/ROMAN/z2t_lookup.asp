            ...
            formLoad();
             <% If (LookupResults.zipInput <> "") Then %>
              <% sqlConnectionString = connStrPublic
                ...
                Dim rs
                Dim sqlText: sqlText = "SELECT Center, Boundaries FROM z2t_WebPublic.dbo.z2t_BoundariesZipCode with(nolock) WHERE ZipCode = '" & LookupResults.zipInput &"'"
                Set rs = Sql(sqlText)
    ...
    <div id="divMain">
      ...
      <div id="divPageMiddle">
        ...
        <div id="divPageCenter" style="clear: none;">
          <!--#include virtual="/Website/pagesTaxRates/ROMAN/page_lookup_content.asp" -->
        </div><!-- divPageCenter -->
        <div id="divPageRight">
