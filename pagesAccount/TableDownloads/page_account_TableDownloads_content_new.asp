...
<!-- class="buttonwide" style="display: inline-block; float: right; margin: 20px 0px;" -->
     ...
     <a class="btn btn-danger" style="float: right;" href="javascript:openPopUp('/Website/pagesAccount/page_account_TableDownloadHistory_content.asp'), void(0);">&nbsp;&nbsp;&nbsp;Download History&nbsp;&nbsp;&nbsp;</a>
