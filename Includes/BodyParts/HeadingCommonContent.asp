				...
				$(document).ready(function() {
					...
					function changeWindow()
					{
					    ...
					    if (scroll >= topArea)
					    {
					    	...
					    	$('.scrollHide').hide();
					    	$('.scrollShow').show();
					    	$('.ahoneDiv').attr('class','col-sm-3 fontWhite18Bold ahoneDiv');
					    	...
					    	$('.ahoneDiv').css('margin', '10px auto 0');
					    ...
					    else
					    {
					    	...
					    	$('.scrollHide').show();
					    	$('.scrollShow').hide();
					    	$('.ahoneDiv').attr('class','col-lg-3 col-md-3 col-sm-3 fontWhite18Bold ahoneDiv');
