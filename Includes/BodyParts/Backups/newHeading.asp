...
%>
					<li class="dropdown">
					  <a href="/my-account" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Welcome, <% Response.Write DisplayCompanyName() %><span class="caret"></span></a>
					  <ul class="dropdown-menu" role="menu">
...
%>
					<li class="dropdown">
					  <a href="/website/pagesAccount/login.asp" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Login</a>
					</li>
<%
end if
%>
