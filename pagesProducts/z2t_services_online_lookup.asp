...
<%
    Session("activePage") = "Online Lookup Information"
    Session("currentPage") = "z2t_services_online_lookup.asp"
%>
  ...
  <body>  
    <div class="container-fluid" style="padding: 0px;">
      ...
      <div class="mainBody">
        ...
        <div class="container">   
		      <!-- #include virtual="/Website/pagesProducts/Services/page_services_online_lookup_content.asp" -->
