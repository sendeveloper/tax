...
<%
    Session("activePage") = "Specialty Tables - Chargeover"
    Session("currentPage") = "z2t_specialty_tables_chargeover.asp"
%>
  ...
  <body>  
    <div class="container-fluid" style="padding: 0px;">
      ...
      <div class="mainBody">
        ...
        <div class="container">
		<!-- #include virtual="/Website/pagesProducts/SpecialtyTables/page_specialty_tables_content_chargeover.asp" -->
