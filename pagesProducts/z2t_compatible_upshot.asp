...
<%
    Session("activePage") = "Compatibility - Upshot"
    Session("currentPage") = "z2t_compatible_upshot.asp"
%>
  ...
  <body>  
    <div class="container-fluid" style="padding: 0px;">
      ...
      <div class="mainBody">
        ...
        <div class="container">   
		<!-- #include virtual="/Website/pagesProducts/Compatible/page_compatible_content_upshot.asp" -->
