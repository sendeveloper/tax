...
<%
    Session("activePage") = "Specialty Tables - Kamp-Data"
    Session("currentPage") = "z2t_specialty_tables_kampdata.asp"
%>
...
<html>
  <head>
    ...
    <!--#include virtual="/Website/Includes/BodyParts/newHeading.asp"-->
		...
		<!-- #include virtual="/Website/pagesProducts/SpecialtyTables/page_specialty_tables_content_kampdata.asp" -->
