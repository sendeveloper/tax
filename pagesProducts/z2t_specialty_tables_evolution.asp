...
<%
    Session("activePage") = "Specialty Tables - Evolution"
    Session("currentPage") = "z2t_specialty_tables_evolution.asp"
%>
...
<html>
  <head>
    ...
    <!--#include virtual="/Website/Includes/BodyParts/newHeading.asp"-->
		...
		<!-- #include virtual="/Website/pagesProducts/SpecialtyTables/page_specialty_tables_content_evolution.asp" -->
