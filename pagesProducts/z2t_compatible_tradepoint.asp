...
<%
    Session("activePage") = "Compatibility - Tradepoint"
    Session("currentPage") = "z2t_compatible_tradepoint.asp"
%>
  ...
  <body>  
    <div class="container-fluid" style="padding: 0px;">
      ...
      <div class="mainBody">
        ...
        <div class="container">
		<!-- #include virtual="/Website/pagesProducts/Compatible/page_compatible_content_tradepoint.asp" -->
