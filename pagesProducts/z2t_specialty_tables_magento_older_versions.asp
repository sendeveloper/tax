...
<%
    Session("activePage") = "Specialty Tables - Magento Older Version"
    Session("currentPage") = "z2t_specialty_tables_magento_older_versions.asp"
%>
...
<html>
  <head>
    ...
    <!--#include virtual="/Website/Includes/BodyParts/newHeading.asp"-->
		...
		<!-- #include virtual="/Website/pagesProducts/SpecialtyTables/page_specialty_tables_content_magento_older_versions.asp" -->
