...
<%
    Session("activePage") = "Specialty Tables - Fleapay"
    Session("currentPage") = "z2t_specialty_tables_fleapay.asp"
%>
...
<html>
  <head>
    ...
    <!--#include virtual="/Website/Includes/BodyParts/newHeading.asp"-->
		...
		<!-- #include virtual="/Website/pagesProducts/SpecialtyTables/page_specialty_tables_content_fleapay.asp" -->
