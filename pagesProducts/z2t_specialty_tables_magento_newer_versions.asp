...
<%
    Session("activePage") = "Specialty Tables - Magento Newer Version"
    Session("currentPage") = "z2t_specialty_tables_magento_newer_versions.asp"
%>
...
<html>
  <head>
    ...
    <!--#include virtual="/Website/Includes/BodyParts/newHeading.asp"-->
		...
		<!-- #include virtual="/Website/pagesProducts/SpecialtyTables/page_specialty_tables_content_magento_newer_versions.asp" -->
        <!-- #include virtual="/Website/pagesProducts/SpecialtyTables/page_specialty_tables_right_sidebar_new.asp" -->
    </div>
