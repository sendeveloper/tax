...
<%
    Session("activePage") = "Specialty Tables - Volusion"
    Session("currentPage") = "z2t_specialty_tables_volusion.asp"
%>
...
<html>
  <head>
    ...
    <!--#include virtual="/Website/Includes/BodyParts/newHeading.asp"-->
		...
		<!-- #include virtual="/Website/pagesProducts/SpecialtyTables/page_specialty_tables_content_volusion.asp" -->
