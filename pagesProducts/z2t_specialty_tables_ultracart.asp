...
<%
    Session("activePage") = "Specialty Tables - Ultracart"
    Session("currentPage") = "z2t_specialty_tables_ultracart.asp"
%>
...
<html>
  <head>
    ...
    <!--#include virtual="/Website/Includes/BodyParts/newHeading.asp"-->
		...
		<!-- #include virtual="/Website/pagesProducts/SpecialtyTables/page_specialty_tables_content_ultracart.asp" -->
