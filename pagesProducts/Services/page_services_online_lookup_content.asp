	...
	<h2><span class="glyph glyphicon glyphicon-star redFont" ariahidden="true"></span><strong>Access Rates With A Free Mobile App!</strong></h2>
		<div>
			...
			<ul style="list-style: none;">
				<li style="display:inline; padding-top: 20px; padding-bottom: 20px; padding-left: 20px; padding-right: 20px;"><a href='https://play.google.com/store/apps/details?id=com.zip2tax&pcampaignid=MKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1'><img width="290" height="110" alt='Get it on Google Play' src='https://play.google.com/intl/en_us/badges/images/generic/en_badge_web_generic.png'/></a></li>
				<li style="display:inline; padding-top: 20px; padding-bottom: 20px; padding-left: 20px; padding-right: 20px;"><a href="https://appsto.re/us/ofMC1.i" onclick="ga('send', 'event', App Leads', Button Interaction', 'appbuttonclicked');"><img src="/Website/Images/app/apple_app_store_button.png" width="250" height="75" alt="Download Sales Tax on Apple"></a></li>
			</ul>
		</div>
			...
			<div class="text-center">
				<ul style="list-style: none;">
					...
					<li style="display:inline; padding-top: 20px; padding-bottom: 20px; padding-left: 20px; padding-right: 20px;">
						...
						text-shadow: 1px 2px 8px rgba(0, 0, 0, 0.52);
						white-space: nowrap;
						text-align: center;">Download</a></li>
				</ul>
			</div>
		</div><br>
