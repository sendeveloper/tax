...
<div class="col-md-9 content">
	...
	<p>
		...
		interface works with mobile devices too!
	...
	<tbody>
        <tr>
          <td>
            <strong><a class="HiddenSummary1" href="javascript:;">ZIP Code resolution</a></strong>
            <div id="HiddenSummary1" class="hiddenContent">
        ...
        <tr>
          <td>
            <strong><a class="HiddenSummary2" href="javascript:;">ZIP+4 resolution</a></strong>
            <div id="HiddenSummary2" class="hiddenContent">
	...
	<p class="noPadding">
		...
		your eCommerce applications with realtime sales tax data. Powerful 
		Microsoft SQL Server and MySQL databases offer several custom interfaces 
		so that your IT professional can program your applications to access our 
		data at lightning speeds. Our servers boast a 99.9% uptime and our 
		network is designed for optimum response time and redundancy, regardless 
		of your global location.
		<br>
		<span class="firstword">Visit 
		<a href='/developers-interface'>Information 
		for developers</a></span> to test compatibility with our sample code or 
		call (866) 492-8494 for a free trial account.
		<br>
		<span class="firstword">Do you plan to resell</span> Zip2Tax's data by 
		incorporating it into your own application? Find out more about the 
		<a href="/Website/pagesProducts/z2t_redistribution.asp">Value Added 
		Reseller</a> license.
	</p>
	...
	<p class="noPadding">
        ...
        3rd-party shopping carts to large enterprise solutions, our .CSV-format
        Sales and Use Tax Tables  offer a wide range of options to meet
        your needs. You can buy a single table for a single state or get the
        whole country and you can opt for the monthly update subscription to
        keep up with the latest rate and ZIP code changes.
        <br>
        <span class="firstword">Do you plan to resell</span> Zip2Tax's data by 
        incorporating it into your own application? Find out more about the
        <a href="/Website/pagesProducts/z2t_redistribution.asp">Value Added
...
<div class="NoPrint">
        ...
        <a href='/Website/Downloads/Sample_Tables/Zip2TaxTableLayoutInformation.pdf' title="U.S. table definitions"target='_blank'>column layout</a>.
          ...
          not limited to, <a href="/Website/pagesProducts/z2t_compatible.asp#upshot_commerce" target="_self">Upshot Commerce</a>, 
          <a href="/Website/pagesProducts/z2t_compatible.asp#smith_cart" target="_self">Smith Cart</a>, and <a href="/Website/pagesProducts/z2t_compatible.asp#tradepoint" target="_self">Tradepoint Enterprise</a>.
...
<div class="clearfix"></div>
	...
	<p class="noPadding">If you don&#39;t see what you need here, E-mail a sample of the format you require to 
