...
<%
    Session("activePage") = ".CSV Table Information"
    Session("currentPage") = "z2t_services_tables.asp"
%>
...
<body>  
  <div class="container-fluid" style="padding: 0px;">
    ...
    <div class="mainBody">
      ...
      <div class="container">   
		    <!-- #include virtual="/Website/pagesProducts/Services/page_services_tables_content.asp" -->
