...
<%
    Session("activePage") = "Specialty Tables - Oracle"
    Session("currentPage") = "z2t_specialty_tables_oracle.asp"
%>
...
<html>
  <head>
    ...
    <!--#include virtual="/Website/Includes/BodyParts/newHeading.asp"-->
		...
		<!-- #include virtual="/Website/pagesProducts/SpecialtyTables/page_specialty_tables_content_oracle.asp" -->
