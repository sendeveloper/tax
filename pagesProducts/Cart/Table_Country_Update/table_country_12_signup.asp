...
<div class="col-lg-12 content">
	...
	Tax Table - United States <br> Update Subscription - 12 Months
	</h2>
	<hr>
	...
	<p class="noPadding">You will be sent notification every month when the new table is ready for download</p>
    <hr>
 ...
 <form method="post" action="http://www.ewebcart.com/17202/cart" accept-charset="utf-8">
      <fieldset>
		...
		<tbody>
			<tr>
				<td>
					<input type="radio" name="option1|Tax type" value="Sales Tax|1200" checked>
			...
			<tr>
				<td>
					<input type="radio" name="option1|Tax type" value="Use Tax|1200">
			...
			<tr>
				<td>
					<input type="radio" name="option1|Tax type" value="Both sales and use Tax|1300">
