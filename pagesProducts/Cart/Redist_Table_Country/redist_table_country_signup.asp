<div id="content">
  <div  class="post">
    <h1 class="title">Redistributable Tax Table - United States<br>
    1 Month</h1>
	...
	<form method="post" action="http://www.ewebcart.com/17202/cart" accept-charset="utf-8">
	  ...
	  <legend></legend>
		<table width="100%" border="0" cellspacing="5" cellpadding="2">
		  ...
		  <tr>
		    <td>
			  <input type="radio" name="option1|Tax type" value="Sales Tax|4125" checked>
		    ...
		    <td>&nbsp;</td>
		    <td style="text-align: right"><strong>$4,125.00</strong></td>
		  </tr>
          <tr>
			<td>
			  <input type="radio" name="option1|Tax type" value="Use Tax|4125">
		  ...
		  <tr>
		    <td>
			  <input type="radio" name="option1|Tax type" value="Both sales and use Tax|660">
			  ...
			  use tax that is different</a> than the sales tax.</td>
		    <td><span class="firstword">A $3,300 value</span></td>
		    <td style="text-align: right"><strong>$4,950.00</strong></td>
		  </tr>
		</table>
 ...
 <br><br>
		...
		<span class="firstword">  Up to a  $4,120 value</span>
  
	<br><br><hr><br>
  <p>What software are you integrating this with?
          <input name="option4|Integration" size="35"></p>
 ...
 <br>
		...
		<p> To add another product, just click &quot;Back to Shopping&quot; from the next screen.</p>
	  </fieldset>
    </form>

	  

	  <!--<p><a href="/Website/pagesProducts/z2t_services.asp" target="_self">Back to shopping</a></p>-->
	  <p><a href="/free-sales-tax-calculator" target="_parent" onClick="closeWin()">Back to shopping</a></p>
</div>
</div>
