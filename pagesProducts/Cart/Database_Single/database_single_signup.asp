      ...
      <fieldset>
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<input type="radio" name="option1|Resolution Level" value="Spot-On Sales Tax|752">
					$752.00 per year				
				</td>
				<td>&nbsp;</td>
				<td>	
					<input type="radio" name="option1|Resolution Level" value="Spot-On Sales &amp; Use Tax|906">
					$906.00 per year		
				</td>
			</tr>
		</tbody>
