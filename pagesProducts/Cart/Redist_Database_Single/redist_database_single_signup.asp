...
<div id="content">
  <div  class="post">
    <h1 class="title">Redistributable Database Interface - <br>Single State</h1>
  </div>
  ...
  <div class="entry">
    <form method="post" action="http://www.ewebcart.com/17202/cart" accept-charset="utf-8">
      <fieldset style="border:0; margin:0; padding:0; text-align: left;">
        ...
        These rates are based on up to 10,000 queries per month. Call (866) 492-8494 for rates on higher 
		service levels.
            ...
            <p id="HiddenSummary1" style="DISPLAY: none" >
              <strong><img src="/Website/Images/Services/ZIP-code-sm.png" class="imgLeft" alt="Zip Code resolution" align="left">
				...
				within a ZIP code, giving the operator the ability to choose the jurisdiction they want.
                   ...
                   <td align="right" valign="top"><input type="radio" name="option1|Resolution Level" value="ZIP Code Sales Tax|1475"  checked="checked" >
                   <span style="text-align: right; font-weight: bold;">$1,475.00</span> per year</td>
                   <td valign="top" style="text-align: right">&nbsp;</td>
                   <td align="right" valign="top"><input type="radio" name="option1|Resolution Level" value="ZIP Code Sales &amp; Use Tax|1777.11" >
                   <span style="text-align: right; font-weight: bold;">$1,777.11</span> per year</td>
            </tr>
          ...
          <td>
            ...
            <p id="HiddenSummary2" style="DISPLAY: none" >
			  ...
			  of addresses, such as 100 to 120 East Main St.
                   ...
                   <input type="radio" name="option1|Resolution Level" value="ZIP+4  Sales Tax|3420.14" >
                   $3,420.14</span> per year </td>                        
                   <td valign="top" style="text-align: right">&nbsp;</td>
                   <td align="right" valign="top"><span style="text-align: right; font-weight: bold;">
                   <input type="radio" name="option1|Resolution Level" value="ZIP+4 Sales &amp; Use Tax|4120.66" > 
                   $4,120.66 </span>per year</td>
            </tr>
		...
		<input name="quantity" value="1" size="3"><input type="hidden" name="item_id" value="37"></h3>
		<br>
		<hr>
		<br>
        <h2><strong>Select a state*</strong></h2>
		...
		*Required field<br><br>
		...
		<a href="mailto:info@zip2tax.com">E-mail </a> or call (866) 492-8494 if you have questions.<br>
		<br>
        <h3><span class="firstword">That's it!</span> No hidden costs, no activation fees, no handling fees, no maintenance.</h3>
        <br>
		<input type="hidden" name="require" value="option1|Resolution level~option2|State">
		<br><input type="submit" name="add" value="         Add To Cart        "class="redButton s11"onClick="ga('send', 'event', 'Button', 'Click');">
		<br><br>

		<!--<p><a href="/Website/pagesProducts/z2t_redistribution.asp" target="_blank">Back to shopping</a></p>-->
		<a href="/Website/pagesProducts/z2t_redistribution.asp" target="_parent" onClick="closeWin()"><strong>Back to shopping</strong></a>
