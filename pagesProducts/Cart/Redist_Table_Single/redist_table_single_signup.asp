...
<div id="content">
  <div  class="post">
    <h1 class="title">Redistributable Tax Table - Single State
    <br> 
    1 Month</h1>
	
    <img src="/Website/Images/ServicesBox/CSV-Table.png" class="imgLeft" alt="Zip Code resolution">
    ...
    <form method="post" action="http://www.ewebcart.com/17202/cart" accept-charset="utf-8">
      <fieldset style="border:0;margin:0;padding:0">
		...
		<table width="100%" border="0" cellspacing="5" cellpadding="2">
		  <tr>
		    <td width="60%"><h2>Tax type</h2></td>
		    <td width="30%">&nbsp;</td>
		    <td width="10%" style="text-align: right"><strong>Total</strong></td>
		  </tr>
		  <tr>
		    <td>
		  	  <input type="radio" name="option1|Tax type" value="Sales Tax|415.00" checked>
		    ...
		    <td>&nbsp;</td>
		    <td style="text-align: right"><strong>$415.00</strong></td>
		  </tr>
		  <tr>
		    <td>
			  <input type="radio" name="option1|Tax type" value="Use Tax|415.00">
		  ...
		  <tr>
		    <td>
			  <input type="radio" name="option1|Tax type" value="Both sales and use Tax|495">
		    ...
		    <td><span class="firstword">A $335 value</span></td>
		    <td style="text-align: right"><strong>$495.00</strong></td>
		  </tr>
	    </table>
		...
		<table width="100%" border="0" cellspacing="5" cellpadding="2">
		  <tr>
			<td width="50%"><h2>Table format</h2></td>
			<td width="29%" style="text-align: right">&nbsp;</td>
			<td width="21%" style="text-align: right"><br></td>
		  </tr>
		  <tr>
			<td>
			  ...
			  Full Breakout</a>
			  <p id="HiddenSummary4" style="DISPLAY: none" >The full breakout table provide all tax 
			  rates broken down for every jurisdictional level including ZIP code, state, county, city 
			  and special districts along with jurisdiction codes (where applicable). They provide the 
			  ...
			  multiple jurisdictions so you can choose the one that most closely matches the location 
			  you seek.</p>
			</td>
		  ...
		  <tr>
			...
			<td valign="top" style="text-align: right"><a href="/Website/Downloads/Sample_Tables/Zip2Tax_Basic_Sample.csv" title="downloadable basic sample">Sample basic table</a></td>
			<td valign="top" style="text-align: right"><a href="/Website/Downloads/Sample_Tables/Zip2TaxBasicSalesTableLayoutInformation.pdf" title="Basic layout information" target="_blank">Layout information</a></td>
		  </tr>
		  <tr>
            <td>
              ...
              Unique ZIPs</a>
              <p id="HiddenSummary7" style="DISPLAY: none" >The unique ZIPs table provides just one row per 
			  ZIP code. This row is the municipality containing the U.S. postal office (also called the 
			  Primary Record) and may or may not be representative of the tax rates of other communities 
			  sharing that ZIP code.</p>
            </td>
            <td valign="top" style="text-align: right"><a href="/Website/Downloads/Sample_Tables/Zip2Tax_UniqueZip_Sample.csv" title="downloadable Unique ZIPs sample table">Sample Unique ZIPs table</a></td>
            <td valign="top" style="text-align: right"><a href="/Website/Downloads/Sample_Tables/Zip2TaxUniqueZipsTableLayoutInformation.pdf" title="Unique ZIPs layout information" target="_blank">Layout information</a></td>
          </tr>
          <tr>
            <td valign="top"><input type="radio" name="option2|Table format" value="NY Clothing">
            ...
            New York State implemented a year-round exemption from sales and use taxes for certain clothing, 
			footwear, and items  used to make or repair exempt clothing. There are several exemptions which 
			may or may not apply to locally imposed sales and use taxes. For more information on New York's 
			clothing exemptions, 
        ...
        <tr>
          <td>
            ...
            An eCommerce storefront specially designed for office products vendors. For more information, 
			<a href="http://evolution-ecommerce.net/" target="_blank">click here</a>.</p>
          </td>
          <td valign="top" style="text-align: right"><a href="/Website/Downloads/Sample_Tables/Zip2Tax_Evolution_Sample.csv" title="downloadable sample Evolution table">Sample Evolution table</a></td>
          <td valign="top" style="text-align: right"><a href="/Website/Downloads/Sample_Tables/Zip2TaxEvolutionTableLayoutInformation.pdf" title="Evolution layout information" target="_blank">Layout information</a></td>
        </tr>
	  ...
	  <tr>
		<td>
		  ...
		  Advertised as the #1 financial software for security companies, this table contains not 
		  just the standard sales tax data, but also specifics about the taxability of labor, 
		  inventory, service agreements and delivery. For more information about Sedona Office, 
		  <a href="http://www.sedonaoffice.com/" target="_blank">click here</a>.</p>
		</td>
		<td valign="top" style="text-align: right"><a href="/Website/Downloads/Sample_Tables/Zip2Tax_Sedona_Sample.csv" title="downloadable sample Sedona table">Sample Sedona table</a></td>
		<td valign="top" style="text-align: right"><a href="/Website/Downloads/Sample_Tables/Zip2TaxSedonaTableLayoutInformation.pdf" title="Sedona layout information" target="_blank">Layout information</a></td>
	  </tr>
	  <tr>
        <td>
          ...
          In development for over 15 years, the UltraCart platform provides you with state of the 
		  art tools to manage every aspect of your e-commerce business. For more information about 
		  Ultracart, <a href="http://www.ultracart.com/" target="_blank">click here</a>.</p>
        </td>
        <td valign="top" style="text-align: right"><a href="/Website/Downloads/Sample_Tables/ultracart_sample_table.csv" title="Downloadable sample Ultracart table">Sample Ultracart table</a></td>
        <td valign="top" style="text-align: right"><a href="/Website/Downloads/Sample_Tables/UltracartTaxTableTerminology.pdf" title="Ultracart layout information">Layout information</a></td>
      </tr>
	  <tr>
		<td>
		...
		<td valign="top" style="text-align: right"><a href="/Website/Downloads/Sample_Tables/volusion_sample_table.csv" title="downloadable sample Volusion table">Sample Volusion table</a></td>
		<td valign="top" style="text-align: right"><a href="/Website/Downloads/Sample_Tables/VolusionTaxTableTerminology.pdf" title="Volusion layout information" target="_blank">Layout information</a></td>
	  </tr>
 ...
 <br><br>
       ...
       Add a second table in another format for<strong> $5</strong>
       <select name="option3|Second format">
               <option value="No Thanks|0">No Thanks</option>
               <option value="Full Breakout|5">Full Breakout</option>
               <option value="Basic|5">Basic</option>
               <option value="Unique ZIPs|5">Unique ZIPs</option>
               <option value="NY Clothing|5">NY Clothing</option>
               <option value="Evolution|5">Evolution</option>
               <option value="Magento|5">Magento</option>
               <option value="Magento Enterprise|5">Magento Enterprise</option>
               <option value="Sedona|5">Sedona</option>
               <option value="Ultracart|5">Ultracart</option>
               <option value="Volusion|5">Volusion</option>
               <option value="Oracle|5">Oracle</option>
       </select>
       <span class="firstword">A $415 value</span><br>
    ...
    *Required field<br>
    ...
    <p>What software are you integrating this with?
    <input name="option5|Integration" size="35"></p>
	<p>Buy purchasing this product, you are agreeing to the terms of the 
	<a href="/Website/pagesExtra/z2t_redistribution_agreement.asp" target="_blank">Redistribution License Agreement</a>.<br> 
	<a href="mailto:info@zip2tax.com">E-mail </a> or call (866) 492-8494 if you have questions.</p>
                
	<h3><span class="firstword">That's it!</span> No hidden costs, no activation fees, no handling fees, no maintenance fees - ever!</h3>
	<br>
	<input type="hidden" name="item_id" value="39">
	<input type="hidden" name="require" value="option4|State:">
	<input type="submit" name="add" value="                Add To Cart               "class="redButton s11"onClick="ga('send', 'event', 'Button', 'Click');">
	<p> To add another state just click &quot;Back to Shopping&quot; from the next screen.</p>
	<br>
  </fieldset>
</form>

<!--<p><a href="/Website/pagesProducts/z2t_redistribution.asp" target="_blank">Back to shopping</a></p>-->
<p><a href="/Website/pagesProducts/z2t_redistribution.asp" target="_parent" onClick="closeWin()">Back to shopping</a></p>
