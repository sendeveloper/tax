...
<div class="col-lg-12 content">
	...
	Tax Table - Canada | 1 Month
	</h2>
	<hr>
	<img src="/Website/Images/ServicesBox/CSV-Table.png" class="left" alt=".CSV tax table">
    <p>This versatile and affordable data file provides general tax rates for Canada's provinces and territories and is designed to be compatible with a variety of shopping carts, ERP systems and eCommerce platforms.
	</p>
 ...
 <form method="post" action="http://www.ewebcart.com/17202/cart" accept-charset="utf-8">
      <fieldset>
		...
		<thead>
			<tr>
				<th width="60%"><h4><strong>Tax type - Canada</strong></h4></th>
				<th width="30%"></th>
