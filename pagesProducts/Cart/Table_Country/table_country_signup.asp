...
<div class="col-lg-12 content">
	...
	Tax Table - United States | 1 Month
	</h2>
	<hr>
 ...
 <form method="post" action="http://www.ewebcart.com/17202/cart" accept-charset="utf-8">
      <fieldset>
		...
		<tbody>
			<tr>
				<td>
					<input type="radio" name="option1|Tax type" value="Sales Tax|550" checked>
			...
			<tr>
				<td>
					<input type="radio" name="option1|Tax type" value="Use Tax|550">
