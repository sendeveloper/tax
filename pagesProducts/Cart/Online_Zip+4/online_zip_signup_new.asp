...
<div class="col-lg-12 content">
	...
	<form method="post" action="http://www.ewebcart.com/17202/cart" accept-charset="utf-8" onsubmit="answer.value=a.value + c.value" oninput="answer.value=a.value + c.value">
		Select a <span style="color: red">Tax Type</span><br>
		<input type="radio" id="a" name="Tax Type" value="Sales Tax">Sales Tax<br>
		<input type="radio" id="a" name="Tax Type" value="Sales Tax With Use Tax">Sales & Use Tax<br><br>
		
		Select a <span style="color: red">Resolution</span><br>
		<input type="radio" id="b" name="Resolution" value="ZIP">ZIP Code<br>
		<input type="radio" id="b" name="Resolution" value="ZIP4">ZIP+4<br>
		<input type="radio" id="b" name="Resolution" value="SPOT-ON">Spot-On&trade;<br><br>
		
		Select a <span style="color: red">Term</span><br>
		<input type="radio" id="c" name="Term" value="1 Month">1 Month<br>
		<input type="radio" id="c" name="Term" value="12 Months">1 Year<br><br>
