...
<div class="col-lg-12 content">
	...
	Online Lookup - ZIP+4  Resolution
	</h1>
	<hr>
	<img src="/Website/Images/Services/ZIP-plus-4-sm.png" class="left" alt="ZIP+4 resolution">
    <p>A very high level of jurisdictional certainty at an affordable price. Sometimes referred 
	to as the 9-digit ZIP code, the first 5 digits determine a delivery area, such as a town 
	and state, and the additional 4 digits target the location to within one side of a street 
	within a range of addresses, such as 100 to 120 East Main St.
	</p>
...
<thead>
 <tr>
<th width="33%"><h4><strong class="firstword">Sales
Tax</strong></h4></th>
...
<tbody>
 <tr>
<td>
<input type="radio" name="option1|Subscription length" value="1
Month Sales Tax|44.00">
...
<td><strong>$44.00</strong></td>
 ...
 <tr>
<td>
<input type="radio" name="option1|Subscription length" value="3
Months Sales Tax|120.00">
...
<td><strong>$120.00</strong></td>
 ...
 <tr>
<td>
<input type="radio" name="option1|Subscription length" value="6
Months Sales Tax|210.00">
...
<td><strong>$210.00</strong></td>
 ...
 <tr class="special">
<td>
<input type="radio" name="option1|Subscription length" value="12
Months Sales Tax|330.00" checked="">
...
<thead>
 <tr>
<th width="33%"><h4><strong class="firstword">Sales &amp; Use
Tax</strong></h4></th>
<th width="12%"><strong>Per Month</strong></th>
<th width="6%"><strong>Total</strong></th>
 </tr>
...
<td>
<input type="radio" name="option1|Subscription length" value="1
Month Sales Tax With Use Tax|55.00">
<strong>1 Month</strong></td>
<td>$55.00</td>
...
<td>
<input type="radio" name="option1|Subscription length" value="3
Months Sales Tax With Use Tax|150.00">
<strong>3 Months</strong>
</td>
<td>$50.00</td>
...
<td>
<input type="radio" name="option1|Subscription length" value="6
Months Sales Tax With Use Tax|255.00">
<strong>6 Months</strong></td>
<td>$45.50</td>
...
<td>
<input type="radio" name="option1|Subscription length" value="12
Months Sales Tax With Use Tax|414.00">
<strong>12 Months</strong></td>
<td>$34.50</td>
