...
<html>
  <head>
	...
	<script type="text/javascript" src="/Website/pagesProducts/Cart/Redist_Table_Country_Update/redist_table_country_update.js" language="javascript"></script>
  ...
  <body>
    <!-- #include virtual="/Website/pagesProducts/Cart/Redist_Table_Country_Update/redist_table_country_update_signup.asp" -->
