...
<div id="content">
  <div  class="post">
    <h1 class="title">Redistributable Tax Table - Single State<br> Update Subscription - 12 Months</h1>
	
    <img src="/Website/Images/ServicesBox/CSV-Table.png" class="imgLeft" alt=".CSV tax table">
 ...
 <p>You will be sent notification every month when the new table is ready for download.</p>
	...
	<form method="post" action="http://www.ewebcart.com/17202/cart" accept-charset="utf-8">
	  <fieldset style="border:0;margin:0;padding:0">
		...
		<table width="100%" border="0" cellspacing="5" cellpadding="2">
		  ...
		  <tr>
		    <td>
			  <input type="radio" name="option1|Tax type" value="Sales Tax|1160" checked>
		    ...
		    <td>&nbsp;</td>
		    <td style="text-align: right"><strong>$1,160.00</strong></td>
		  </tr>
          <tr>
			<td>
			  <input type="radio" name="option1|Tax type" value="Use Tax|1160">
		  ...
		  <tr>
		    <td>
			  <input type="radio" name="option1|Tax type" value="Both sales and use Tax|1390">
		    ...
		    <td><span class="firstword">A $930 value</span></td>
		    <td style="text-align: right"><strong>$1,390.00</strong></td>
		  </tr>
		</table>
      ...
      <span class="firstword">A $1,100 value</span><br><br>
      <br><hr><br>
	...
	*Required field<br><br>
    ...
    <input name="option5|Integration" size="35">
    <br>
  </p>
