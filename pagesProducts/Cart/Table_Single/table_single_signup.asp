...
<div class="col-lg-12 content">
	...
	Tax Table - Single State | 1 Month
	</h2>
	<hr>
 ...
 <form method="post" action="http://www.ewebcart.com/17202/cart" accept-charset="utf-8">
      <fieldset>
		...
		<tbody>
			<tr>
				<td>
					<input type="radio" name="option1|Tax type" value="Sales Tax|55" checked>
			...
			<tr>
				<td>
					<input type="radio" name="option1|Tax type" value="Use Tax|55">
			...
			<tr>
				<td>
					<input type="radio" name="option1|Tax type" value="Both sales and use Tax|66">
