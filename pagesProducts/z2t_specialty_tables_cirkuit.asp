...
<%
    Session("activePage") = "Specialty Tables - Cirkuit"
    Session("currentPage") = "z2t_specialty_tables_cirkuit.asp"
%>
...
<html>
  <head>
    ...
    <!--#include virtual="/Website/Includes/BodyParts/newHeading.asp"-->
		...
		<!-- #include virtual="/Website/pagesProducts/SpecialtyTables/page_specialty_tables_content_cirkuit.asp" -->
